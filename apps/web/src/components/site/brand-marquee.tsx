    ...
    case 'volkswagen':
      return (
        <svg viewBox="0 0 72 72" aria-hidden="true" className="size-11 text-foreground">
          ...
          <path
            d="M19 22l8.2 24L36 28.5 44.8 46 53 22"
            fill="none"
            stroke="currentColor"
            strokeWidth="3.5"
            strokeLinecap="round"
    ...
    case 'hyundai':
      return (
        <svg viewBox="0 0 108 72" aria-hidden="true" className="h-11 w-[4.5rem] text-foreground">
          ...
          />
          <path
            d="M38 48l6-24m20 24l-6-24M44 36h14"
            fill="none"
            stroke="currentColor"
            strokeWidth="4"
            strokeLinecap="round"
