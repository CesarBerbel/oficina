...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Veículos', href: '/veiculos', icon: Car, permission: Permission.VEHICLES_READ },
      {
        ...
        href: '/check-in',
        icon: ClipboardCheck,
        permission: Permission.VEHICLES_READ,
      },
      {
        label: 'Ordens de Serviço',
        href: '/os',
        icon: ClipboardList,
        permission: Permission.OS_READ,
      },
      {
        label: 'Kanban Técnico',
        href: '/kanban',
        icon: KanbanSquare,
        permission: Permission.OS_READ,
      },
  ...
  },
  {
    ...
    items: [
      { label: 'Serviços', href: '/servicos', icon: Wrench, permission: Permission.SERVICES_READ },
      {
        ...
        href: '/combos',
        icon: PackageCheck,
        permission: Permission.SERVICES_READ,
      },
    ],
  },
  {
    ...
    items: [
      { label: 'Estoque', href: '/estoque', icon: Package, permission: Permission.INVENTORY_READ },
      {
        ...
        href: '/nfe-import',
        icon: FileInput,
        permission: Permission.NFE_IMPORT,
      },
      {
        label: 'Compras',
        href: '/compras',
        icon: ShoppingCart,
        permission: Permission.PURCHASES_READ,
      },
      {
        label: 'Financeiro',
        href: '/financeiro',
