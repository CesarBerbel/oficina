    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Cadastre contas a receber, contas a pagar, despesas ou receitas manuais.
          </DialogDescription>
        </DialogHeader>
        <form className="space-y-4" onSubmit={onSubmit}>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <Select
                value={form.type}
                onChange={(e) => set('type', e.target.value as FinancialEntryType)}
              >
                {Object.values(FinancialEntryType).map((type) => (
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <Input
                placeholder="Serviços, peças, aluguel..."
                value={form.category}
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={create.isPending}>
              {create.isPending && <CarLoader className="size-4 animate-spin" />} Criar
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
