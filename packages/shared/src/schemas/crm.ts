...
}, { message: 'O início do retorno pós-entrega deve ser menor ou igual ao fim.', path: ['postDeliveryStartDays'] }).refine((data) => {
...
}, { message: 'Prioridade média deve ter prazo menor ou igual à alta.', path: ['mediumPriorityDays'] });
